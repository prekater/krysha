      ...
      <div className={styles.fieldText}>
        {terminationRules.length > 0
          ? terminationRules.map((r, i) => (
              <p key={i} className={styles.terminationRule}>
                Если договор расторгнут по инициативе арендатора ранее, чем
                через {r.period} {periodText.PLURAL}, регулярный платеж
                увеличится на {r.value} {currencyText}.
              </p>
            ))
          : 'Отсутствуют'}
      </div>
