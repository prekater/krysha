          ...
          expect(res.body).toEqual(
            {
              ...
              "termsContent": [{
                ...
                "terminationRules": "в размере 145000 руб. в месяцев при расторжении до 3 месяцев; в размере 150000 руб. в месяцев при расторжении до 6 месяцев",
                ...
                "depositCollectTypeOptions": [{
                  ...
                  "priceAffect": 0,
                  "isEnabled": false,
                  "label": "При заезде: Без депозита, каждый месяц стоит дороже на 0 руб."
                }, {
                  "type": "PARTIAL",
                  "priceAffect": "2000",
                  "isEnabled": true,
                ...
                "depositReturnType": "В случае разрыва контракта: Стоимость месяца пересчитывается",
                "depositReturnPeriod": "в течение 0 календарных undefined",
                "depositContent": "Помимо арендной платы Арендатор вносит также обеспечительный платеж в размере 100000 руб.. При условии оплаты разовой комиссию Арендодателю на сумму «1000» руб. Арендатор вносить обеспечительный платеж следующим путем: половину обеспечительного платежа одновременно с первым платежом аренды; остаток одновременно со вторым платежом аренды",
                "terminationRules": "в размере 160000 руб. в месяцев при расторжении до 3 месяцев; в размере 140000 руб. в месяцев при расторжении до 6 месяцев; в размере 120000 руб. в месяцев при расторжении до 9 месяцев",
                ...
                "depositReturnType": "В случае разрыва контракта: Стоимость месяца пересчитывается",
                "depositReturnPeriod": "в течение 0 календарных undefined",
                "terminationRules": "в размере 110000 руб. в месяцев при расторжении до 6 месяцев",
